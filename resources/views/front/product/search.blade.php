            ...
            <div class="col-sm-12 col-xs-12">
                <article class="col-main">
                    <div class="page-title">
                        <h1>Result(s) Search for "{{ request()->input('query') }}"</h1>
                    </div>
                    @if(count($products)>0)
                        ...
                        <ol class="products-list" id="products-list">
                            ...
                            <li class="item">
                                ...
                                <div class="product-shop">
                                    <h2 class="product-name"><a href="{{url('/product/'.$product->product_name)}}" title="Product tilte is here">{{$product->product_name}}</a></h2>
                                    <div class="desc std">
